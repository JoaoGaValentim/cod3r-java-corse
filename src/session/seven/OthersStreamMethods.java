...
public class OthersStreamMethods {
    public static void main(String[] args) {
        ...
        System.out.println("---- distinct => lim 3 ----");
        students.stream().distinct().skip(2).limit(3).forEach(System.out::println);
        System.out.println("---- distinct => takeWhile ----");
        students.stream().distinct().takeWhile(s -> s.getAverage() >= 9.2).forEach(System.out::println);
