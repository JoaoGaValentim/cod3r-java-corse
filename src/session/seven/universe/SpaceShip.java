...
public class SpaceShip {
        public static void main(String[] args) {
                ...
                List<Planet> planets = Arrays.asList(
                                new Planet("Mercúrio", 3.3e23, 57.9e6, 88.0, 1, Arrays.asList("ferro"), false, galaxy,
                                                null),
                                new Planet("Vênus", 4.87e24, 108.2e6, 225.0, 0, Arrays.asList("dióxido de carbono"),
                                                false, galaxy,
                                                null),
                                new Planet("Terra", 5.97e24, 149.6e6, 365.2, 1, Arrays.asList("oxigênio", "água"), true,
                                                galaxy, null),
                                new Planet("Marte", 6.42e23, 227.9e6, 687.0, 2,
                                                Arrays.asList("ferro", "dióxido de carbono"), false,
                                                galaxy, null),
                                new Planet("Júpiter", 1.90e27, 778.3e6, 4331.0, 79,
                                                Arrays.asList("hidrogênio", "hélio"), false, galaxy,
                                                null),
                                new Planet("Saturno", 5.68e26, 1_427.0e6, 10747.0, 82,
                                                Arrays.asList("hidrogênio", "hélio"), false,
                                                galaxy, null),
                                new Planet("Urano", 8.68e25, 2_871.0e6, 30589.0, 27,
